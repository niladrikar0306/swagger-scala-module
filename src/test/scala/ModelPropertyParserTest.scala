...
//  }
  ...
  it should "process Model with Scala Option Boolean" in {
    ...
    val mem = typeOf[ModelWOptionBoolean].members

    val values = typeOf[ModelWOptionBoolean].members.filterNot(_.isMethod)
    ...
    optBoolean shouldBe a [properties.BooleanProperty]
